...
/* harmony import */ var _components_accordions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/accordions */ "./src/js/components/accordions.js");
/* harmony import */ var _components_accordions__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_accordions__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _components_selects__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/selects */ "./src/js/components/selects.js");
/* harmony import */ var _components_selects__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_selects__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _components_scroll_min__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/scroll.min */ "./src/js/components/scroll.min.js");
/* harmony import */ var _components_scroll_min__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_scroll_min__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_modal_min__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/modal.min */ "./src/js/components/modal.min.js");
/* harmony import */ var _components_modal_min__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_modal_min__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _vendor_accordion_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/accordion.js */ "./src/js/vendor/accordion.js");
/* harmony import */ var _vendor_accordion_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_accordion_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/choices.min.js */ "./src/js/vendor/choices.min.js");
/* harmony import */ var _vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendor_choices_min_js__WEBPACK_IMPORTED_MODULE_3__);
...
/***/ "./src/js/components/modal.min.js":
/*!****************************************!*\
  !*** ./src/js/components/modal.min.js ***!
  \****************************************/
/***/ (() => {
...
const portfolioTabsItemsVissible = document.querySelectorAll('.portfolio-tabs__item--vissible');
  ...
  portfolioTabsNav.addEventListener('click', e => {
    ...
    if (target.classList.contains('portfolio-tabs-nav__btn')) {
      ...
      portfolioTabsItems.forEach(el => {
        el.classList.remove('portfolio-tabs__item--vissible');
      });
      document.querySelectorAll(`[data-target=${path}]`).forEach(el => {
        el.closest('.portfolio-tabs__item').classList.add('portfolio-tabs__item--vissible');
      });
      if (path == 'all') {
        portfolioTabsItems.forEach(el => {
          el.classList.add('portfolio-tabs__item--vissible');
        });
      }
    }
  });

  // if (portfolioTabsItemsVissible.length <= 9) {
...
/***/ "./src/js/components/scroll.min.js":
/*!*****************************************!*\
  !*** ./src/js/components/scroll.min.js ***!
  \*****************************************/
/***/ (() => {
...
window.addEventListener('scroll', () => {
  ...
  let heroHeight = document.querySelector('.page-hero').offsetHeight;
  if (y > heroHeight) {
...
// const gap = bodyStyles.getPropertyValue('--gap');
// console.log(gap);
...
const relatedProjectsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.related-projects__items', {
  slidesPerView: 1,
  spaceBetween: 30,
  loop: true,
  navigation: {
...
if (historySlider) {
  const aboutSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](historySlider, {
    spaceBetween: 20,
    slidesPerView: 1,
    navigation: {
  ...
  historyBtns.forEach((el, id) => {
    el.setAttribute('data-index', id);
...
const heroSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__slider', {
  slidesPerView: 1,
  // loop: true,
  navigation: {
    nextEl: '.hero__next',
...
if (videoBlock) {
  ...
  playBtn.addEventListener('click', () => {
    playBtn.classList.add('video-block__play--active');
    videoBlock.classList.add('video-block--active');
    video.play();
    video.controls = true;
  });
  video.onpause = function () {
    playBtn.classList.remove('video-block__play--active');
    videoBlock.classList.remove('video-block--active');
