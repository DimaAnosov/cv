...
/* harmony import */ var _components_selects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/selects */ "./src/js/components/selects.js");
/* harmony import */ var _components_selects__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_selects__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_inputs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/inputs */ "./src/js/components/inputs.js");
/* harmony import */ var _components_inputs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_inputs__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_tooltip__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/tooltip */ "./src/js/components/tooltip.js");
...
/* harmony import */ var _vendor_nouislider_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/nouislider.min.js */ "./src/js/vendor/nouislider.min.js");
/* harmony import */ var _vendor_nouislider_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_nouislider_min_js__WEBPACK_IMPORTED_MODULE_2__);
...
const searchIc = document.querySelector('#search-ic');
const searcBtn = document.querySelector('.search__btn');
searchInput.addEventListener('input', () => {
  searchInput.classList.add('not-focus');
  searchIc.classList.add('is-focus');
});
searchInput.addEventListener('change', () => {
  searchInput.classList.remove('not-focus');
  searchIc.classList.remove('is-focus');
});
...
//////////////////////////
const formchInput = document.querySelectorAll('.form__input');
formchInput.forEach(el => {
...
if (rangeSlider) {
  _vendor_nouislider_min__WEBPACK_IMPORTED_MODULE_0___default().create(rangeSlider, {
    start: [10000, 150000],
    connect: true,
    step: 1000,
    range: {
...
const newRegionSelect = new Choices(regionSelect, {
  searchEnabled: false
});
const searchSelect = document.querySelector('.search__select');
const newsearchSelect = new Choices(searchSelect, {
  searchEnabled: false
});
...
const showMoreBtn = document.querySelector('.rating__show-more');
const ratingContent = document.querySelectorAll('.rating__card');
const ratingContentLength = document.querySelectorAll('.rating__card').length;
let counter = 8;
if (showMoreBtn) {
  showMoreBtn.addEventListener('click', () => {
    counter += 4;
    const ratingArray = Array.from(document.querySelector('.rating__content').children);
    const newRatingContent = ratingArray.slice(0, counter);
    newRatingContent.forEach(el => {
      el.classList.add('is-visible');
    });
    if (newRatingContent.length === ratingContentLength) {
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs]);
const heroSwiper = document.querySelector('.hero__slider');
if (heroSwiper) {
  const newHeroSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](heroSwiper, {
    loop: true,
    // autoplay: {
    //   delay: 5000,
    // },
...
const offersSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.offers__slider', {
  slidesPerView: 1,
  spaceBetween: 12,
  // slidesPerGroup: 1,
  breakpoints: {
...
const usefulSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.useful__slider', {
  slidesPerView: 1,
  spaceBetween: 32,
  breakpoints: {
    576: {
...
const catalogSwiper = document.querySelector('.catalog__slider');
if (catalogSwiper) {
  const newCatalogSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](catalogSwiper, {
    pagination: {
      el: '.catalog__pagination',
      clickable: true,
      renderBullet: function (index, className) {
        return `<span class="${className} catalog__pagination-bullet">${index + 1}</span>`;
      }
    }
  });
}
;
const similarSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.similar__slider', {
  slidesPerView: 4,
  spaceBetween: 32,
  navigation: {
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".mySwiper", {
  spaceBetween: 32,
  slidesPerView: 4,
  freeMode: true,
  watchSlidesProgress: true
});
const swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".mySwiper2", {
  spaceBetween: 10,
  navigation: {
...
const newswiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".newmySwiper", {
  spaceBetween: 78,
  slidesPerView: 4,
  freeMode: true,
  watchSlidesProgress: true
});
const newswiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".newmySwiper2", {
  spaceBetween: 10,
  navigation: {
...
const btn = document.querySelector('.tooltip__btn');
const tooltip = document.querySelector('.tooltip__txt');

(0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(btn, tooltip, {
  placement: 'top'
});
